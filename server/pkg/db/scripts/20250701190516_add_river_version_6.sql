...
-- river migrate-get --line main --all --exclude-version 1 --up >> pkg/db/scripts/20250701190516_add_river_version_6.sql
-- river migrate-get --line main --all --exclude-version 1 --down >> pkg/db/scripts/20250701190516_add_river_version_6.sql
